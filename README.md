...
<br>
 ...
 <br><br>
  ...
  <div class="w3-panel w3-lime w3-topbar w3-bottombar w3-green">
    ...
    <p id="para3"><br><u> Cause</u>: la notion de cause est liée à celle d'effet. La cause est ce qui entraîne de façon nécessaire un effet. 
    <br><u> Fin</u>: but. Chercher la fin, c'est se poser la question du «pourquoi». 
    <br><br>Exemples:
    ...
    <br>Exemples:
    <br>&nbsp;&nbsp;&nbsp;&nbsp; ⇒ La production d'une statue met en jeu quatre causes.
    </p>
  </div>
 </div>
 <br><br>
 <div class="w3-container">
  <div class="w3-panel w3-pale-yellow w3-topbar w3-bottombar w3-border-amber">
   <p id="para2"><u><i> CONTINGENT  /   NÉCESSAIRE  / POSSIBLE    </i></u></p>
    <p id="para3"><br> 
    <br><u> Contingent</u>: ce qui pourrait ne pas être.
 ...
 <br><br>
  ...
  <div class="w3-panel w3-pale-red w3-topbar w3-bottombar w3-border-red">
    ...
    <p id="para3"><br> <u>Croire</u>: c'est être persuadé de la vérité d'une proposition sans preuve, sans démonstration. La foi (croyance en une proposition qui n'est ni évidente ni démontrable) est un cas particulier de croyance. On peut en effet croire en une proposition dont certes on ignore la démonstration mais qui, néanmoins, est démontrable. 
    <br> <u>Savoir</u>: c'est affirmer avec certitude de celui qui peut avancer des preuves. Savoir, c'est d'être capable de rendre raison de ce qu'on affirme.</p>
  </div>
 </div>
 <br><br>
  <div class="w3-container">
  <div class="w3-panel w3-pale-blue w3-topbar w3-bottombar w3-border-cyan">
    <p id="para2"><u><i>  ESSENTIEL / ACCIDENTEL   </i></u></p>
    <p id="para3"><br><u> Essentiel</u>: ce qui relève de l'essence c'est-à-dire de la définition. Appartient à l'essence d'une chose ce qui ne peut être ôté d'une chose sans faire disparître en même temps la chose.
    <br><u>Accidentel</u>: on appelle accidentelle toute qualité fortuite d'un objet qu'on pourrait lui retirer sans modifier fondamentalement.
    <br><br>Exemples:
    <br>&nbsp;&nbsp;&nbsp;&nbsp; ⇒Il fait partie de l'<b>essence</b> de l'homme d'être bipède ou d'être doé de raison. En revanche avoir les yeux bleus est un <b>accident</b>.       </p>
  </div>
 </div>
 <br><br>
  <div class="w3-container">
  <div class="w3-panel w3-lime w3-topbar w3-bottombar w3-border-green">
    <p id="para2"><u><i> EXPLIQUER  /  COMPRENDRE   </i></u></p>
    <p id="para3"><br> Cf. ANALYSER  /  SYNTHÈSE
    </p>
  </div>
 </div>
 <br><br>
 ...
 <div class="w3-container">
  <div class="w3-panel w3-pale-yellow w3-topbar w3-bottombar w3-border-amber">
    <p id="para2"><u><i> EN FAT  /  EN DROIT   </i></u></p>
    <p id="para3"><br> Le <u>fait</u>: est ce qui est.
    <br>Le <u>droit</u>: est ce qui est légitime, ce qui devrait être. 
    <br><br>Exemples:
    <br>&nbsp;&nbsp;&nbsp;&nbsp; ⇒  Le viol est un fait mais non un droit.
    <br><br>  ⨝ <u><font style="color:red">" Verité </font> de <b>fait</b></u> : verité qui dépend d'un événement.
    <br>Exemple:
    <br>&nbsp;&nbsp;&nbsp;&nbsp; ⇒ Balzac est mort en 1850.
    <br><br>  ⨝ <u><font style="color:red">" Verité </font> de <b>droit</b></u> : verité qui ne dépend pas des événements.
    <br>Exemple:
    <br>&nbsp;&nbsp;&nbsp;&nbsp; ⇒ 2 + 2 = 4     </p>
  </div>
 </div>
